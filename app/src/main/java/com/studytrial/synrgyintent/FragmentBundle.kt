...
class FragmentBundle : Fragment(){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btn_bundle.setOnClickListener {
            if (et_bundle_umur.text.toString().isEmpty() && et_bundle_nama.text.toString()
                    .isEmpty()
            ) {
                Toast.makeText(
                    context,
                ...
                val nama = et_bundle_nama.text
                val umur = Integer.parseInt(et_bundle_umur.text.toString())
                val intent = Intent(context, ActivityBundle::class.java)
                val bundle = Bundle()
